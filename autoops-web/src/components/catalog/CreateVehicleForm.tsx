...
import { createVehicleAction } from '@/actions/orders';
...
export default function CreateVehicleForm({ unknownClientId }: Props) {
  ...
  const [clientQuery, setClientQuery] = useState('Unknown');
